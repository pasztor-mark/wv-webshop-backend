...
public class JwtUtil {
    ...
    public Optional<String> getJwtFromAuth(HttpServletRequest request) {
        if (request.getCookies() != null) {
            System.out.println("VAN COOKIE");
        ...
        if (request.getHeader("Authorization") != null) {
            return Optional.of(request.getHeader("Authorization").split("Bearer ")[1]);
        }
    ...
    public Long getUserIdFromCookie(HttpServletRequest request) {
        Optional<String> jwtToken = getJwtFromAuth(request);
